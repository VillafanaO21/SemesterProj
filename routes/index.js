...
router.get('/order/:orderId/delete', ensureUserAuthenticated, orderController.deleteOrder);
router.get('/order/:orderId/reply/:replyId/delete', ensureUserAuthenticated, orderController.deleteReply);
